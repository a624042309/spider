...
class CoursePathSpider(object):
    ...
    """ 职业路径图网页分析 """
    # 课程章路径
    XPATH_CHAPTER = '//*[@class="bd"]/section/table'
    # 章节名
    xpath_chapter_name = 'thead/tr/th[@colspan="3"]/text()'
    # 章下的课程列表路径
    xpath_chapter_lesson_list = 'tbody[@class="interleave-odd"]/tr/td/a'
    # 课程名和链接
    xpath_lesson_name = 'span/text()'
    xpath_lesson_link = '@href'
    ...
    def parse_html(self):
        ...
        self.title = self.selector.xpath('//h1[@class="caption"]/text()')[0]
        if self.simple_name == '':
