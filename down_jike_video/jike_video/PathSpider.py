...
class PathSpider(object):
    ...
    """ 职业路径图爬虫 """
    # URL_PATH = 'http://ke.jikexueyuan.com/zhiye/'
    # XPATH_PATH_LINK = '//div[@class="overview-text"]/h2/a'
    # XPATH_PATH_NAME = 'div[@class="lesson-overview"]/h2/a/text()'
    # XPATH_PATH_INTRO = 'div[@class="lesson-overview"]/p/a/text()'
...
class _PathInfo(object):
    def __init__(self, selector):
        ...
        self.name = selector.xpath('text()')[0]
        self.inrto = selector.xpath(PathSpider.XPATH_PATH_INTRO)
        self.url = 'http:' + selector.xpath('@href')[0]
